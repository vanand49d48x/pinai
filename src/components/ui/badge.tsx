  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors",
  {
    variants: {
      variant: {
        ...
        generating: "border-transparent bg-blue-100 text-blue-800",
        ready: "border-transparent bg-green-100 text-green-800",
        scheduled: "border-transparent bg-purple-100 text-purple-800",
        publishing: "border-transparent bg-yellow-100 text-yellow-800",
        posted: "border-transparent bg-emerald-100 text-emerald-800",
